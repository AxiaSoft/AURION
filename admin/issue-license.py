...
"""Issue a one-time Axiasoft product key. Run only on the issuer machine.
  ...
  py -3.12 admin/issue-license.py --plan m1 --note customer@gmail.com
  py -3.12 admin/issue-license.py --plan m3 --note 09121234567
  py -3.12 admin/issue-license.py --plan m6
  py -3.12 admin/issue-license.py --plan y1
  py -3.12 admin/issue-license.py --plan developer
"""
