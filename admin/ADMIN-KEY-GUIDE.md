...
**Fix 2026-05-17:** هر دو env `AXIASOFT_KEY_PRIVATE` و `AURION_KEY_PRIVATE_HEX` پذیرفته می‌شود، ابزار لوکال `admin/mint_local.py` خطای `ModuleNotFoundError: No module named 'aurion'` را در ویندوز حل می‌کند.
...
```bash
cd /path/to/AURION
AURION_KEY_PRIVATE_HEX=YOUR_64_HEX_PRIVATE_SEED python admin/mint_local.py developer "admin-owner"
# یا
...
python admin/mint_local.py m1 "client@example.com"
python admin/mint_local.py m3 "client@example.com"
python admin/mint_local.py m6 "client@example.com"
python admin/mint_local.py y1 "client@example.com"
...
python admin/mint_local.py m1 "client@example.com"
admin\mint-key.cmd m1 "client@example.com"
admin\mint-key.cmd y1 "client@example.com"
```

**Linux / macOS:**
```bash
AURION_KEY_PRIVATE_HEX=YOUR_64_HEX_PRIVATE_SEED python admin/mint_local.py m1 "client@example.com"
AURION_KEY_PRIVATE_HEX=YOUR_64_HEX_PRIVATE_SEED python admin/mint_local.py y1 "client@example.com"
```
